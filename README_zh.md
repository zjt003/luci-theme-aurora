...
- **opkg** (OpenWrt < 25.12):
  ...
  ```sh
  cd /tmp && uclient-fetch -O luci-theme-aurora.ipk https://xget.xi-xu.me/gh/eamonxg/luci-theme-aurora/releases/latest/download/luci-theme-aurora_0.11.0-r20260208_all.ipk && opkg install luci-theme-aurora.ipk
  ```

- **apk** (OpenWrt 25.12+ 及 snapshots):

  ```sh
  cd /tmp && uclient-fetch -O luci-theme-aurora.apk https://xget.xi-xu.me/gh/eamonxg/luci-theme-aurora/releases/latest/download/luci-theme-aurora-0.11.0-r20260208.apk && apk add --allow-untrusted luci-theme-aurora.apk
  ```
